...
public class MenuItemManager extends EntityManager implements AddObject, SelectMenuItems, ModifyObject, RemoveObject, PrintAllObjects{
	...
	public void addObject() {
		...
		menuItemList.add(new MenuItem(getCounter(), name, description, price));
		setCounter(getCounter() + 1);
		this.writeToFile(menuItemList, MenuItem.class);
		...
		do {
			...
			switch(option) {
				case 0:
					...
					writeToFile(menuItemList, MenuItem.class);
					break;
				case 1:
					String name = "";
					while (name.equals("")) {
